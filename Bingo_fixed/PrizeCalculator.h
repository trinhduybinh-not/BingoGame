...
// ══════════════════════════════════════════════════════
//
//  PrizeCalculator đóng gói toàn bộ logic tính tiền:
//  - Giá vé mỗi phiếu (ticketPrice)
//  - Hệ số thưởng (bonusMultiplier): thưởng = b × tổng thu
//  - Tỉ lệ giảm (decayPercent): giảm x% mỗi k lần bốc
//  - Khoảng giảm (decayInterval): sau mỗi k lần bốc
//
//  Bên ngoài chỉ cần gọi calculate() và getHouseProfit()
// ══════════════════════════════════════════════════════
